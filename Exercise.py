...
"""
    Hezron has some cards with numbers written on them. She arranges the cards in decreasing order, and lays them out face down in a sequence on a table. She challenge bob to pick out the card containing a given number by turing over as few cards as possible. Write a function to help Bob  locate card.
"""